...
## Set working directory such that it CONTAINS the two folders Code and Data  
wd <- "set/path/to/working/directory"
setwd(wd)

load("./Data/Chapter15.RData")
library(rnaturalearth)  ## for spatial information in plots
source("./Code/AuxiliaryPlots.R") ## auxiliary plot functions
...
## please note: 
## fitmaxstab is iterated six times, each time the fitted values are used 
## as new starting values for the next iteration;
## after five iterations no further improvement has been possible
...
load("./Data/inlandBRsimu_30.RData")
simu.res <- simu$res
