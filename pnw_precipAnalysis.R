...
#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!
#
#   DATA SETS ARE LARGE!  THERE ARE 7746 LOCATIONS AND 8511 DAYS TOTAL  
#   THIS SCRIPT HAS A FEW COMPUTATIONALLY EXPENSIVE COMPONENTS
#         (it takes ~6 hours to run on my old laptop)
#
#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!
#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!#!
...
library(maps)
setwd("PATH TO FILE ")
precip_data1 <- readRDS("./pnw_precip_data_1of_9.rds")
precip_data2 <- readRDS("./pnw_precip_data_2of_9.rds")
precip_data3 <- readRDS("./pnw_precip_data_3of_9.rds")
precip_data4 <- readRDS("./pnw_precip_data_4of_9.rds")
precip_data5 <- readRDS("./pnw_precip_data_5of_9.rds")
precip_data6 <- readRDS("./pnw_precip_data_6of_9.rds")
precip_data7 <- readRDS("./pnw_precip_data_7of_9.rds")
precip_data8 <- readRDS("./pnw_precip_data_8of_9.rds")
precip_data9 <- readRDS("./pnw_precip_data_9of_9.rds")
precip_data <- cbind(precip_data1, precip_data2, precip_data3, precip_data4, 
                     precip_data5, precip_data6, precip_data7, precip_data8, 
                     precip_data9)
